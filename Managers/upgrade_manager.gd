...
func dmg(amount : float, upgrade : Upgrade, curse : bool) ->void:
...
func speed(amount: float,upgrade : Upgrade, curse : bool) ->void:
	player_upgrade_manager = get_tree().get_first_node_in_group("PlayerUpgradeManager")
...
func hp(amount : int,upgrade : Upgrade, curse : bool) ->void:
	player_upgrade_manager = get_tree().get_first_node_in_group("PlayerUpgradeManager")
...
func attack_speed(amount : int,upgrade : Upgrade, curse : bool) ->void:
	player_upgrade_manager = get_tree().get_first_node_in_group("PlayerUpgradeManager")
